...
class Phi3VModel(Phi3VPreTrainedModel):
    ...
    def forward(
        ...
        if len(idx_w_image):
            ...
            # Use stack instead of cat to preserve batch dimension: [num_images, num_crops, channels, height, width]
            ...
            # Use stack instead of cat to preserve batch dimension and squeeze extra dim: [num_images, 2]
            valid_image_sizes = torch.stack(valid_image_sizes).squeeze(1).to(input_ids.device)
