...
# from src.data.dataset.hf_datasets import interleave_datasets  # REMOVED - not needed for Phi-3-V
...
def init_mixed_dataset(dataset_config, model_args, data_args, training_args):
    ...
    if len(train_datasets) > 1:
        train_dataset = interleave_datasets(train_datasets, probabilities=probs,
